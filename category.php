...
<body>
	<div class="container">
		...
		<div class="category">
			...
			style="margin-left:auto;width:200px; height: fit-content;">
				<?php if ($categories == 0){
					// do nothing
				}else{ ?>
				<a href="#"
				   class="list-group-item list-group-item-action active"
				   style="background:#f4bfd4 ;border:#f4bfd4; font-size:18px;
							font-weight: 600;">Categorías</a>
				   <?php foreach ($categories as $category ) {?>
			...
			<!-- List of authors -->
			<div class="list-group mt-5"style="margin-left:autowidth:200px; height: fit-content;">
				<?php if ($authors == 0){
					// do nothing
				}else{ ?>
				<a href="#"
